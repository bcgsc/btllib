...
int main() {
    ...
    for (int iteration = 0; iteration < 3; iteration++) {
        ...
        btllib::SeqWriter random_seqs2(random_filename2, btllib::SeqWriter::FASTQ, false);
        ...
        for (int s = 0; s < 500; s++) {
            ...
            #pragma omp critical
            {
                name = generated_names2.back(); generated_names2.pop_back();
                comment = generated_comments2.back(); generated_comments2.pop_back();
                seq = generated_seqs2.back(); generated_seqs2.pop_back();
                qual = generated_quals2.back(); generated_quals2.pop_back();
            }
