...
get_blocks(const std::vector<std::string>& seed_strings,
           std::vector<btllib::typedefs::SpacedSeedBlocks>& blocks,
           std::vector<btllib::typedefs::SpacedSeedMonomers>& monomers)
{
  for (const auto& seed_string : seed_strings) {
    ...
    btllib::typedefs::SpacedSeedBlocks care_blocks, ignore_blocks;
...
ntmsm64(const char* kmer_seq,
        const std::vector<btllib::typedefs::SpacedSeedBlocks>& seeds_blocks,
        const std::vector<btllib::typedefs::SpacedSeedMonomers>& seeds_monomers,
        unsigned k,
        unsigned m,
        unsigned m2,
        uint64_t* fh_nomonos,
